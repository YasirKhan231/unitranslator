// app/dashboard/translator/page.js
"use client";
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-6">
        ...
        <div className="flex flex-col md:flex-row gap-4 mb-6">
          ...
          <button
            ...
            className="self-end mb-2 p-2 hover:bg-gray-100 rounded-lg transition disabled:opacity-50 disabled:cursor-not-allowed"
          ...
          <div>
            <div className="flex justify-between items-center mb-2">
              <label className="text-sm font-medium text-gray-700">
                {fromLang === "auto" ? "Source Text" : languages.find(l => l.code === fromLang)?.name || "Source Text"}
              </label>
              <button
                onClick={clearText}
